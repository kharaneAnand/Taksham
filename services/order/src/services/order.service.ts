...
import type {
  OrderEmailStatus,
} from "../templates/order-status.template.js";
    ...
    */
    ...
    if (
      ...
      try {
        ...
        const emailStatuses: OrderEmailStatus[] = [
          "processing",
          "shipped",
          "out_for_delivery",
          "delivered",
        ...
        if (emailStatuses.includes(
          requestedStatus as OrderEmailStatus,
        )) {
